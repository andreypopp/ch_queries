...
module Expr = struct
  ...
  let toIntervalSecond x = def "toIntervalSecond" [ x ]
  ...
  let toUInt64OrNull x = def "toUInt64OrNull" [ x ]
  let toUInt32 x = def "toUInt32" [ x ]
  let toUInt16 x = def "toUInt16" [ x ]
  let toUInt8 x = def "toUInt8" [ x ]
  ...
  let toStringCutToZero x = def "toStringCutToZero" [ x ]
